...
```{=tex}
\vspace{0.5cm}
\small \textbf{Tabla 17}    Análisis retrospectivo, y sus implicancias en las variables de estados y parámetros del modelo (mod003). \vspace{0.1cm} \normalsize
```
...
```{=tex}
\vspace{0.5cm}
\small \textbf{Tabla 18}    Análisis retrospectivo, y sus implicancias en las variables de estados y parámetros del modelo (mod003b). \vspace{0.1cm} \normalsize
```
