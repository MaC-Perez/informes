...
N_(a,1977)={■(R_0,"                      " a=1@N_(a-1,1) e^(-M),"         " a>2,⋯,m-1."                       " @N_(a-1,1)/((1-e^(-M) ) ),"        " a=m)┤

La biomasa desovante virginal (en número) es obtenida como,

S_0=e^(-9M/12) ∑_(a=1)^m▒〖N_(a,t) 〖ms〗_a w_a,"    " t=1977,〗

donde 〖ms〗_a y w_a corresponden a la proporción de hembras maduras y pesos medios a la edad a, respectivamente.
...
R_t=S_(t-1)/(a+bS_(t-1) ) e^((ϵ_t^R-(σ_R^2)/2) ),
...
S_t=∑_(a=1)^m▒〖N_(a,t) e^((-9)/12 Z_(a,t) ) 〖ms〗_a w_a.〗

	Evolución temporal de cohortes
La abundancia de merluza del sur a la edad a al tiempo t, es modelada por


N_(a,t)={■(R_(a,t),"                                                                   " a=1@N_(a-1,t-1) e^(〖-Z〗_(a-1,t-1) ),"                                         " a>2,⋯,m-1,"                       " @N_(a-1,t-1) e^(〖-Z〗_(a-1,t-1) )+N_(a,t-1) e^(〖-Z〗_(a,t-1) ),"         " a=m)┤

tal que,
Z_(a,t)=M+∑_(i=1)^g▒〖S_a^g F_t^g,〗
...
S_a^g={■(2^(〖-[(a-k)/υ^l ]〗^2 ),"          " a≤k@2^(〖-[(a-k)/υ^r ]〗^2 ),"          " a>k)┤.
...
I_t^g=q_g e^(-0.5M) (∑_t▒∑_a▒〖S_a^g N_(a,t) w_(a,t) 〗) e^(ϵ_t ),
...
La proporción de edad observada de las flotas de pesca (p ̅_(a,t)^g ) y los cruceros (p ̅_(a,t)^cru )  fueron obtenidas mediante,
p ̅_(a,t)^g=(C_(a,t)^g)/(∑_a▒C_(a,t)^g ),"              " p ̅_(a,t)^cru=(N_(a,t)^cru)/(∑_a▒N_(a,t)^cru ) ,
...
El desembarque anual por flota, Y ̂_t^g, es modelado asumiendo un error de observación en el proceso de pesca, de esta forma, los desembarques son estimados como:

C ̂_(a,t)^g=N_(a,t) w_a  (F_(a,t)^g (1-e^(〖-Z〗_(a,t) ) ))/〖-Z〗_(a,t)   ,

Y ̂_t^g=∑_g▒∑_a▒C ̂_(a,t)^g    .
...
〖BD〗_RMS=〖BD〗_(40%Bo)=R_0*〖bdpr〗_(F=0)*0.4,

es decir, la biomasa desovante virginal reducida a un 40%. Donde 〖BD〗_RMS y F_RMS  representan los PBR objetivos, los cuales son consistentes con el requerimiento de manejar los stocks comerciales en base al RMS; mientras que 〖bdpr〗_(F=0) representa la biomasa desovante por recluta en ausencia de explotación (F=0) para un nivel de reclutamiento medio o virginal Ro. Complementariamente, se estableció como PBR límite para la biomasa desovante, el 50% de 〖BD〗_RMS, que es equivalente a 〖BD〗_(20%Bo).
...
N_a={■(1@N_(a-1) exp(-M-F*S_(a-1) )@(N_(a-1) exp(-M-F*S_(a-1) ))/(1-exp(-M-F*S_m ) ))┤,       ■(a=1@1<a<m@a=m) ,
...
〖bdpr〗_(F=0)= ∑_(a=0)^t▒〖N_a exp⁡(-d_t M)m_a w ̅_a 〗   ,
〖bdpr〗_(F_RMS )= ∑_(a=0)^t▒〖N_a exp⁡(-d_t (s_a F_RMS+M) 〖)m〗_a w ̅_a,〗  
...
f=(〖BDPR〗_(F_RMS )/〖BDPR〗_(F=0) -0,45)^2.
